...
class ToolDateTime(object):
    ...
    def get_date_string(param="s"):
        ...
        eg: 2018-08_test_fall-29T09-38-19-776474Z
    ...
    def int_to_string(date_time_int, param=None):
        ...
        Convert int to string
         eg: 1534492036898632  ->  2018-08_test_fall-17T15-47-16-898632Z
             1534492036898632  ->  2018-08_test_fall-17T15-47-16Z
    ...
    def string_to_datetime(date_time_string):
        ...
        elif 'T' in date_time_string:
            datetime_object = datetime.strptime(date_time_string, '%Y-%m-%dT%H:%M:%S')
        else:
    ...
    def date_rounding_up(date_time):
        ...
        eg: 2018-08_test_fall-17T15-47-16-898632Z  -> 2018-08_test_fall-17T15-47-17Z
        :param date_time:
        :return:
        """
    ...
    def get_delta_time(date_time_a, date_time_b, format='string'):
        ...
        返回两时间的差值，以秒为单位
        :param date_time_a: "2018-08_test_fall-17T15-47-16Z"
        :param date_time_b: "2018-08_test_fall-17T15-47-15Z"
    ...
    @staticmethod
    def get_quarter_spread(contract):
        year = int(f'20{contract[:2]}')
        month = int(contract[-2:])
        a = datetime(year, month, 1)
        b= a + timedelta(days=31)
        f = datetime(b.year, b.month, 1)
        last_day = f + timedelta(minutes=-1)
        first_day = last_day + timedelta(days=-300)
        return str(first_day), str(last_day)


if __name__ == '__main__':
    a = ToolDateTime.get_quarter_spread('2006')
    print(a)
    # a = ToolDateTime.get_date_int('us')
